...
**URL :** [https://tiptop-cesar99.onrender.com](https://tiptop-cesar99.onrender.com)

**Compte démo :** `+237 695 21 47 85` / OTP `1234`

Si le nom `tiptop-cesar99` est déjà pris, change `name:` dans `render.yaml` et l’URL dans `apps/android/app/src/main/res/values/strings.xml`.
