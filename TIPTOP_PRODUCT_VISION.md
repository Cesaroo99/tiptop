...
**J’ai besoin → Je tape → Le plus proche ou le moins cher s’affiche → J’y vais**
...
ce soir. Une offre n’est pas une pub : c’est un pain, un pressing, une coupe,
un shooting — **près de toi**, avec un prix et une carte.
...
Quelqu’un a besoin d’un produit ou d’un service. Il tape sur TipTop. Les
endroits **les plus proches** — ou **les moins chers** — qui l’ont dans
son entourage s’affichent, avec le prix et la carte pour s’y rendre.

Ce sont les boutiques, les entreprises et les particuliers qui renseignent
ces offres **à l’avance**. TipTop ne invente pas un stock mondial : il
range ce qui existe déjà dans ta zone.

Filtres : produit / service, distance max, tri proximité ou prix.
Chaque fiche mène à un itinéraire réel.

## Ce que TipTop n’est pas

- Pas un clone TikTok avec une tab « events » collée après.
- Pas un fil d’événements derrière le bouton Events.
- Pas un site vitrine desktop qui cache la barre du téléphone.
