...
async function main() {
  ...
  if (!paid) {
    ...
    await prisma.event.update({ where: { id: paid.id }, data: { paymentRule: "PAY_REQUIRED", allowGroups: true } });
  }
...
async function enrichLivingWorld(
      ...
      create: {
        ...
        profile: {
          create: {
            ...
            availabilityUntil: (u.availability ?? "AVAILABLE") === "AVAILABLE" ? availableUntil : null,
            locationPrecision: "ZONE",
  ...
  for (const [eventId, userId, status] of [
    ...
    [piscine.id, onguene.id, "RESERVED"],
    [piscine.id, amina.id, "RESERVED"],
    [piscine.id, fouda.id, "RESERVED"],
  ...
  await db.offer.deleteMany({
    where: { sellerId: { in: [amina.id, erica.id, koffi.id, william.id, nadege.id, fouda.id, cesar.id] } },
  });
    ...
    data: [
      {
        ...
        description: "Baguettes et pains au lait, four à 6h. Prends le tien en passant.",
        shopName: "Boulangerie Fouda",
        priceXaf: 250,
        city: "Yaoundé",
        zone: "Odza",
        placeName: "Boulangerie Fouda",
        address: "Carrefour Odza, Yaoundé",
        latitude: 3.8,
        longitude: 11.54,
        imageUrl: "/seed/posts/food.jpg",
      },
      {
        sellerId: amina.id,
        kind: "SERVICE",
        sellerKind: "BUSINESS",
        title: "Pressing express 24h",
        description: "Costume, robe, linge du quotidien. Prêt le lendemain.",
        shopName: "Pressing Amina",
        priceXaf: 3500,
        city: "Yaoundé",
        zone: "Bastos",
        placeName: "Pressing Amina",
        address: "Rue 1.770, Bastos, Yaoundé",
        latitude: 3.89,
        longitude: 11.512,
        imageUrl: "/seed/posts/friends.jpg",
      },
      {
        sellerId: nadege.id,
        kind: "SERVICE",
        sellerKind: "PERSON",
        title: "Tresses à domicile",
        description: "Je me déplace dans Ngoa-Ekellé et Damas. 2 à 4 heures.",
        shopName: null,
        priceXaf: 8000,
        city: "Yaoundé",
        zone: "Ngoa-Ekellé",
        placeName: "Ngoa-Ekellé",
        address: "Ngoa-Ekellé, Yaoundé",
        latitude: 3.863,
        longitude: 11.5,
        imageUrl: "/seed/covers/night.jpg",
      },
      {
        sellerId: koffi.id,
        kind: "SERVICE",
        ...
        description: "Salon ouvert jusqu’à 21h. Sans rendez-vous le week-end.",
        shopName: "Barbershop Koffi",
        priceXaf: 4000,
        city: "Yaoundé",
        zone: "Melen",
        placeName: "Barbershop Koffi",
      ...
      },
      {
        ...
        kind: "PRODUCT",
        sellerKind: "SHOP",
        title: "Jus frais pastèque",
        description: "Pressé à la commande, 50 cl. Devant Omnisports.",
        shopName: "Stand William",
        priceXaf: 1000,
        city: "Yaoundé",
        zone: "Omnisports",
        placeName: "Stand William",
        address: "Omnisports, Yaoundé",
        latitude: 3.868,
        longitude: 11.516,
        imageUrl: "/seed/posts/drinks.jpg",
      },
      {
        sellerId: erica.id,
        kind: "SERVICE",
        sellerKind: "BUSINESS",
        title: "Shooting portrait 1h",
        description: "Extérieur Bastos ou studio. 15 photos retouchées.",
        shopName: "Erica Studio",
        priceXaf: 25000,
        city: "Yaoundé",
        zone: "Bastos",
        placeName: "Erica Studio",
      ...
      },
      {
        ...
        kind: "PRODUCT",
        sellerKind: "PERSON",
        title: "Sac à dos toile",
        description: "Fait main, un seul en stock. À récupérer à Damas.",
        shopName: null,
        priceXaf: 12000,
        city: "Yaoundé",
        zone: "Carrefour Damas",
        placeName: "Carrefour Damas",
        address: "Carrefour Damas, Yaoundé",
        latitude: 3.848,
        longitude: 11.5021,
        imageUrl: "/seed/posts/lights.jpg",
      },
    ],
  });
