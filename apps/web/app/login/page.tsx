  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col px-6 py-10">
      ...
      <div className="mt-4 flex justify-center gap-4">
        ...
        <button type="button" onClick={() => setOauth(true)} className="tap-scale grid h-14 w-14 place-items-center rounded-xl bg-surface shadow-xs transition hover:shadow-sm" aria-label="Facebook">
        ...
        <button type="button" onClick={() => setOauth(true)} className="tap-scale grid h-14 w-14 place-items-center rounded-xl bg-surface shadow-xs transition hover:shadow-sm" aria-label="Apple">
